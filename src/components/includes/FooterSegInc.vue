                    ...
                    <div class="col-md-6">
                       <ul class="footer2--list">
                        <li class="footer2--item py-1">
                          <a class="footer--link "><img src="../../../public/assets/img/phone.svg" alt=""> <a href="tel:+258840111248" class="footer--link">841088884</a> | <a
                              href="tel:+258840111428" class="footer--link">840111428</a> |
                            <a href="tel:+258870088688" class="footer--link">870088688</a> </a>
                        </li>
                        <li class="footer2--item py-1">
                          <a href="mailto:info@unitec.ac.mz" class="footer--link"><img src="../../../public/assets/img/email.svg" alt="">
                            info@unitec.ac.mz</a>
                        </li>
                        <li class="footer2--item py-1">
                            <a class="footer--link" href="https://goo.gl/maps/Xkj7sheyf3Wb9iJw6" target="_blank"><img
                                src="../../../public/assets/img/marker2.svg" alt=""> Av. Salvador Allende Nr.60, Maputo</a>
                          </li>
                        <li class="footer2--item py-1">
                        ...
                        <div class="logo-part v-align-center">
                            <a href="https://unitec.ac.mz" class="footer--link text-white py-2">
                                <div class="footer2--logo">
                                    <img src="../../../public/assets/img/unitec.png" class="py-1" alt="">
                                    <img src="../../../public/assets/img/uniconnect.png" class="unispace" alt="">
                                </div>
                            </a>
                        </div>
                    </div>
